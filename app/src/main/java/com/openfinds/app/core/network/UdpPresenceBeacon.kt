 ...
 */
@Singleton
class UdpPresenceBeacon @Inject constructor() {

    suspend fun broadcastLoop(deviceId: String, deviceName: String, tcpPort: Int) {
    ...
    fun listen(): Flow<DiscoveredDevice> = callbackFlow {
