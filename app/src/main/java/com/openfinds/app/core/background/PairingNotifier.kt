...
object PairingNotifier {
    fun notifyIncomingRequest(
        ...
        val notification =
            NotificationCompat.Builder(context, NotificationChannels.PAIRING)
        ...
        context.notifySafely(request.fromDeviceId.hashCode(), notification)
    }
