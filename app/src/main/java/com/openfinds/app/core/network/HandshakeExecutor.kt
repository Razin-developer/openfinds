 ...
 * already-connected Ktor [Socket], producing an authenticated, encrypted
...
class HandshakeExecutor
    ...
    constructor() {
        ...
        suspend fun initiate(
            ...
            val response =
                readPlain(input) as? P2pMessage.HandshakeResponse
            ...
            val confirmPlaintext =
                OpenFindJson.encodeToString(
            ...
            return P2pSession(socket, input, output, cipher, response.fromDeviceId, response.fromDeviceName, response.identityPublicKeyB64)
        }
        ...
        suspend fun respond(
            ...
            val init =
                readPlain(input) as? P2pMessage.HandshakeInit
            ...
            val ackPlaintext =
                OpenFindJson.encodeToString(P2pMessage.serializer(), P2pMessage.Ack() as P2pMessage)
                    .toByteArray(Charsets.UTF_8)
            Framing.writeFrame(output, cipher.encrypt(ackPlaintext))

            return P2pSession(socket, input, output, cipher, init.fromDeviceId, init.fromDeviceName, confirm.identityPublicKeyB64)
        }
        ...
        private suspend fun readPlain(input: ByteReadChannel): P2pMessage {
